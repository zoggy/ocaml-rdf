...
class from : ?sub: Iri.t -> Rdf_graph.graph ->
  object
    ...
    method constrainedBy_iris : Iri.t list
    method constrainedBy_opt_iri : Iri.t option
    method contains : Rdf_term.term list
    method contains_opt : Rdf_term.term option
    method contains_iris : Iri.t list
    method contains_opt_iri : Iri.t option
    method hasMemberRelation : Rdf_term.term list
    method hasMemberRelation_opt : Rdf_term.term option
    method hasMemberRelation_iris : Iri.t list
    method hasMemberRelation_opt_iri : Iri.t option
    ...
    method insertedContentRelation : Rdf_term.term list
    method insertedContentRelation_opt : Rdf_term.term option
    method insertedContentRelation_iris : Iri.t list
    method insertedContentRelation_opt_iri : Iri.t option
    method isMemberOfRelation : Rdf_term.term list
    method isMemberOfRelation_opt : Rdf_term.term option
    method isMemberOfRelation_iris : Iri.t list
    method isMemberOfRelation_opt_iri : Iri.t option
    ...
    method membershipResource : Rdf_term.term list
    method membershipResource_opt : Rdf_term.term option
    method membershipResource_iris : Iri.t list
    method membershipResource_opt_iri : Iri.t option
    method pageSequence : Rdf_term.term list
    method pageSequence_opt : Rdf_term.term option
    method pageSequence_iris : Iri.t list
    method pageSequence_opt_iri : Iri.t option
    method pageSortCollation : Rdf_term.term list
    method pageSortCollation_opt : Rdf_term.term option
    method pageSortCollation_iris : Iri.t list
    method pageSortCollation_opt_iri : Iri.t option
    method pageSortCriteria : Rdf_term.term list
    method pageSortCriteria_opt : Rdf_term.term option
    method pageSortCriteria_iris : Iri.t list
    method pageSortCriteria_opt_iri : Iri.t option
    method pageSortOrder : Rdf_term.term list
    method pageSortOrder_opt : Rdf_term.term option
    method pageSortOrder_iris : Iri.t list
    method pageSortOrder_opt_iri : Iri.t option
    method pageSortPredicate : Rdf_term.term list
    method pageSortPredicate_opt : Rdf_term.term option
    method pageSortPredicate_iris : Iri.t list
    method pageSortPredicate_opt_iri : Iri.t option
  end
