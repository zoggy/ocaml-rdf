...
| Integer { String ($1, None, Some (Iriref (Iri.to_string Rdf_rdf.xsd_integer))) }
| Decimal { String ($1, None, Some (Iriref (Iri.to_string Rdf_rdf.xsd_decimal))) }
| Double { String ($1, None, Some (Iriref (Iri.to_string Rdf_rdf.xsd_double))) }
| Boolean { String ($1, None, Some (Iriref (Iri.to_string Rdf_rdf.xsd_boolean))) }
;
