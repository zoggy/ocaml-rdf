...
class from ?sub g =
  ...
  method atTime = Rdf_graph.iri_objects_of g ~sub ~pred: atTime
  ...
  method endedAtTime = Rdf_graph.iri_objects_of g ~sub ~pred: endedAtTime
  method entity = Rdf_graph.iri_objects_of g ~sub ~pred: entity
  method generated = Rdf_graph.iri_objects_of g ~sub ~pred: generated
  method generatedAtTime = Rdf_graph.iri_objects_of g ~sub ~pred: generatedAtTime
  ...
  method invalidatedAtTime = Rdf_graph.iri_objects_of g ~sub ~pred: invalidatedAtTime
  ...
  method provenanceUriTemplate = Rdf_graph.iri_objects_of g ~sub ~pred: provenanceUriTemplate
  ...
  method startedAtTime = Rdf_graph.iri_objects_of g ~sub ~pred: startedAtTime
  ...
  method value = Rdf_graph.iri_objects_of g ~sub ~pred: value
