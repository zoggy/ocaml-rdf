...
class from ?sub g =
  ...
  object
  method nothing = Rdf_graph.iri_objects_of g ~sub ~pred: nothing
  method thing = Rdf_graph.iri_objects_of g ~sub ~pred: thing
  ...
  method datatypeComplementOf = Rdf_graph.iri_objects_of g ~sub ~pred: datatypeComplementOf
  ...
  method onDataRange = Rdf_graph.iri_objects_of g ~sub ~pred: onDataRange
  method onDatatype = Rdf_graph.iri_objects_of g ~sub ~pred: onDatatype
